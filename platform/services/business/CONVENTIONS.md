...
| `cn.mjy.platform.survey` | 问卷草稿、发布状态机、发布审批、待核对核对、版本与题目绑定 | V500–V599（V500–V509 发布，V510–V519 审批，V520–V529 核对） |
| `cn.mjy.platform.response` | 答卷查询（投影分页、按需经网关取作答、字段字典、数据权限） | V600–V609（06.1 预留；06.1 未建表，尚未使用） |
